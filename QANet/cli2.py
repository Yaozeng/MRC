...
def parse_args():
    ...
    train_settings.add_argument('--decay', type=float, default=0.999,
                                help='decay')
...
def evaluate(args):
    ...
    dev_batches = dataloader.next_batch('dev', 16, vocab.get_word_id(vocab.pad_token),shuffle=False)
...
def predict(args):
    ...
    test_batches = dataloader.next_batch('test', 48, vocab.get_word_id(vocab.pad_token), shuffle=False)
