...
def parse_args():
    ...
    path_settings.add_argument('--train_files', nargs='+',default=['./data/extracted/trainset/search.train.json'],
                               help='list of files that contain the preprocessed train data')
    path_settings.add_argument('--dev_files', nargs='+',default=['./data/extracted/devset/search.dev.json'],
                               help='list of files that contain the preprocessed dev data')
    path_settings.add_argument('--test_files', nargs='+',default=['./data/extracted/test1set/search.test1.json'],
                               help='list of files that contain the preprocessed test data')
    path_settings.add_argument('--save_dir', default='./data/baidu/search/',
                               help='the dir with preprocessed baidu reading comprehension data')
    path_settings.add_argument('--vocab_dir', default='./data/vocab/search/',
                               help='the dir to save vocabulary')
    path_settings.add_argument('--model_dir', default='./data/models/search/',
                               help='the dir to store models')
    path_settings.add_argument('--result_dir', default='./data/results/search/',
                               help='the dir to output the results')
    path_settings.add_argument('--summary_dir', default='./data/summary/search/',
    ...
    path_settings.add_argument('--log_path',default='./data/summary/search/log.txt',
                               help='path of the log file. If not set, logs are printed to console')
...
def predict(args):
    ...
    model = RCModel(vocab, num_train_steps,num_warmup_steps,args)
    model.restore(args.model_dir, 'BIDAF_24000')
