...
from layers.match_layer import AttentionFlowMatchLayer,MatchLSTMLayer,AttentionFlowMatchLayer3,AttentionFlowMatchLayer4
...
class RCModel(object):
    ...
    def _match(self):
        ...
        if self.algo == 'MLSTM':
            ...
            match_layer = AttentionFlowMatchLayer4(self.hidden_size)
        else:
    ...
    def _fuse(self):
        ...
        with tf.variable_scope('fusion2'):
            ...
            self.fuse_p_encodes2, _ = rnn('bi-lstm', gate_output, self.p_length,
